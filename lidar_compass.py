        ...
        try:
            ...
            if data:
                ...
                if len(parts) >= 3:
                    ...
                    ax.scatter(x1, y1, c='blue', label='Ultrasonic')
                    ax.scatter(x2, y2, c='red', label='Lidar')
                    ax.legend()
                    ...
                    # Draw arrow indicating current angle
                    arrow_length = 50
                    arrow_x = arrow_length * math.cos(radians)
                    arrow_y = arrow_length * math.sin(radians)
                    ax.arrow(0, 0, arrow_x, arrow_y, head_width=10, head_length=10, fc='k', ec='k')
